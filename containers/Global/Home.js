...
export default class Home extends React.Component {
  ...
  render() {
    ...
    <GlobalButton marginRight={Dimensions.get('window').width*0.12} onPress={() => navigate('VenueForm', {name: 'Home'})} buttonTitle={"Eateries"} />
    ...
    <GlobalButton marginRight={Dimensions.get('window').width*0.12} onPress={() => navigate('MediaForm', {name: 'Home'})} buttonTitle={"Media"} />
