...
export default class Landing extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <GlobalButton marginLeft={Dimensions.get('window').width*0.12} onPress={() => navigate('Register', {name: 'Home'})} buttonTitle={"Register"} />
      <GlobalButton marginRight={Dimensions.get('window').width*0.20} onPress={() => navigate('Sign in', {name: 'Home'})} buttonTitle={"Sign in"} />
